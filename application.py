...
class Application:
    ...
    def setup_text_areas(self):
        ...
        self.idea_text, self.idea_scrollbar = self.create_text_area("Current Idea", 2, 0)
        self.code_text, self.code_scrollbar = self.create_text_area("Current Code", 2, 2)
        self.feedback_text, self.feedback_scrollbar = self.create_text_area("Current Feedback", 1, 1)
        self.ceo_message, self.ceo_scrollbar = self.create_text_area("CEO Message", 2, 3)
        self.code_output_text, self.code_output_scrollbar = self.create_text_area("Code Execution Result", 2, 1)
    ...
    def setup_buttons(self):
        ...
        self.generate_idea_button = Button(button_frame, text="Generate Project Idea with Initial Code",
                                           command=self.generate_idea, bg="#111111", fg="#00FF00")
        self.refine_code_button = Button(button_frame, text="Refine Code and Get Feedback",
                                         command=self.refine_code, bg="#111111", fg="#00FF00")
        self.save_final_code_button = Button(button_frame, text="Save Final Code",
                                             command=self.save_final_code, bg="#111111", fg="#00FF00")
        self.auto_generate_button = Button(button_frame, text="Auto Generate Program",
