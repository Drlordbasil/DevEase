...
class CodeCreator:
    ...
    def create_initial_code(self, idea, update_callback):
        try:
            prompt = f"You are a super creative Python developer and you have just come up with a new project idea: '{idea}'. Write an initial Python script that represents this idea with full robust logic and functions/classes."
            messages = [
